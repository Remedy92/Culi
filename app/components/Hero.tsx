...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-container-full mx-auto text-center py-20 md:py-20">
        <motion.div
        ...
        >
          ...
          <motion.p
            ...
            className="mx-auto max-w-container-prose md:max-w-max-w-container-standard mx-auto lg:max-w-max-w-container-wide mx-auto text-lg sm:text-lg md:text-xl text-eerie-black/80 px-4 sm:px-0"
          >
            {t.rich('description', {
