...
export function CTASection() {
  ...
  return (
    <section className="py-16 md:py-20 lg:py-24 bg-timberwolf relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-max-w-container-standard mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div
        ...
        >
          ...
          <p className="text-lg md:text-xl text-eerie-black/80 max-w-max-w-container-narrow mx-auto mx-auto">
            {t.rich('description', {
