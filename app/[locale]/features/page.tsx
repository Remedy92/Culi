  ...
  return (
    <>
      ...
      <main className="pt-16">
        <div className="mx-auto max-w-max-w-container-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <h1 className="text-4xl font-bold text-eerie-black text-center mb-4">
            Features That Transform Your Restaurant
          </h1>
          <p className="text-lg text-eerie-black/80 text-center max-w-max-w-container-standard mx-auto mx-auto mb-16">
